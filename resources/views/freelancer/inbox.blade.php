                            ...
                            <div class="modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="chat-header d-flex"
                                        ...
                                        <a href="{{ route('freelancer') }}" title="Back to Dashboard"
                                        ...
                                        <a class="nav-link " href=" {{ route('freelancer.profile') }}"
                                            ...
                                            <img class="img-xs rounded-circle me-2"
                                                src="{{ asset($freelancer->avatar) }}" alt="Profile image"
                                                style="width: 48px">
                                        </a>
                                        <span
                                            style="font-size: 30px; font-weight: bold; margin-bottom: 15px">Message</span>
                                    </div>
                                                ...
                                                <div class="chat-list" id="chatlist"
                                                    ...
                                                    <a href="" class="conv d-flex align-items-center"
                                                        ...
                                                        <div class="flex-shrink-0" style="position: relative;">
                                                            <img class="img-fluid"
                                                                :src="`{{ asset('') }}${conversation.user.company_logo}`"
                                            ...
                                            <div class="col-8">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img class="img-fluid"
                                                            :src="`{{ asset('') }}${selectedConversation.user.company_logo}`"
                                                            alt="user img" style="width: 48px">
                                                    </div>
            ...
            new Vue({
                ...
                methods: {
                    ...
                    fetchMessages(conversationId) {
                        axios.get(`/freelancer/conversations/${conversationId}/messages`)
                            .then(response => {
                    ...
                    sendMessage() {
                        if (this.message.trim() && this.selectedConversation) {
                            ...
                            axios.post(`/freelancer/conversations/${this.selectedConversation.id}/messages`, {
