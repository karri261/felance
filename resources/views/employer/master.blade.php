...
<body>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown"
                                ...
                                <div class="dropdown-header text-center">
                                    <img class="img-md rounded-circle" src="{{ asset($employer->company_logo) }}"
                                        alt="Profile image">
        ...
        <nav class="bottom-navbar collapse d-md-block" id="navigateMenu">
            <div class="container">
                <ul class="nav page-navigation">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('employer') ? 'active' : '' }}"
                            href="{{ route('employer') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('employer/postJob') ? 'active' : '' }}"
                            href="{{ route('employer.postJob') }}">
                            <i class="fa-solid fa-list-check"></i>
                            <span class="menu-title">Post a job</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('employer/inbox*') ? 'active' : '' }}"
                            href="{{ route('employer.inbox') }}">
    ...
    <div class="footer text-center text-lg-start text-white" style="background-color: #181824">
        <div class="container py-4">
            <div class="row">
                <div class="logo-grap col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                    <img class="footer-logo" src="{{ asset('welcome_assets/images/Logo_white.png') }}" alt="">
                </div>
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
            © 2024 Copyright:
            <a class="text-white" href="{{ route('employer') }}">felance.com</a>
        </div>
    </div>
