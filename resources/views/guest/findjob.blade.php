...
@section('title', 'Felance| Find Job')
        ...
        <div class="row">
            <div class="col-lg-9 col-md-8 col-12">
                <div class="tab-content" id="job-list">
                    @include('guest.job-list', ['jobs' => $jobs])
                </div>
            </div>
                ...
                <div class="side-block px-20 py-10 bg-white">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>
                                <input type="checkbox" id="basic_checkbox_2" class="filled-in" name="categories[]"
                                    value="Health" {{ in_array('Health', (array) request('categories')) ? 'checked' : '' }}>
                            ...
                            <li>
                                <input type="checkbox" id="basic_checkbox_5" class="filled-in" name="categories[]"
                                    value="Others" {{ in_array('Others', (array) request('categories')) ? 'checked' : '' }}>
                    ...
                    <div class="widget">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>
                                <input type="radio" id="levels_5" class="filled-in" name="salary" value="all"
                                    {{ request('salary') == 'all' ? 'checked' : '' }}>
                                <label for="levels_5"
                                    class="d-flex justify-content-between align-items-center form-label">
                                    All
                                </label>
