        ...
        <div class="box-body">
            <div class="d-lg-flex justify-content-between">
                <div class="w-100">
                    <div class="d-flex align-items-center" style="margin-bottom: 30px">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <span class="fs-14" style="color: #29B2FE">
                                <a href="{{ route('companyProfile', $job->user_id) }}">
                                    {{ $job->company_name }}
                                </a>
                                -
                    ...
                    <div class="d-lg-flex align-items-center justify-content-between">
                        <div class="d-lg-flex d-block align-items-center">
                            <h6 class="d-inline-block mb-0 rounded fs-14"
                                style=" background-color: #e9edf2; 
                            padding: 5px 10px;
                            color: #172b4c">
                                <span>Salary:</span> ${{ $job->salary_min }} - ${{ $job->salary_max }}
                            </h6>
                            <h6 class="d-inline-block mb-0 rounded mx-10 my-0 fs-14"
                                style=" background-color: #e9edf2; 
                                padding: 5px 10px;
                                color: #172b4c">
                ...
                <div class="position-relative w-xl-300 w-lg-250 ps-lg-20 bs-1 ms-lg-20">
                    <h5 class="mt-lg-0 mt-25 mb-25">
                        <small class="text-fade fs-12">Openings Postition</small><br>
                        <span style="font-family: 'IBM Plex Sans', sans-serif">{{ $job->job_title }}</span>
                    </h5>
