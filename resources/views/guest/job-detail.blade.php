                ...
                <div class="d-lg-flex" style="margin-bottom: 30px">
                    <div class="left-inner text-center">
                        ...
                        <div class="clearfix text-center">
                            <a href="{{ route('findJob') }}" class="btn-link my-10 d-block">View all jobs
                    ...
                    <div class="inner-info ps-lg-30 mt-20">
                        ...
                        <div class="job-date-author fs-14 mb-10">
                            ...
                            <a class="text-primary"
                                href="{{ route('companyProfile', $job->user_id) }}">{{ $job->company_name }}
                            </a>
                        </div>
                                        ...
                                        <div class="d-lg-flex justify-content-between">
                                            <div class="w-100">
                                                <div class="d-flex align-items-center" style="margin-bottom: 30px">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <span class="fs-14">
                                                            <a href="{{ route('companyProfile', $relatedJob->user_id) }}">
                                            ...
                                            color: #172b4c">
                                                ...
                                                color: #172b4c">
                                                    ...
                                                    <div class="ms-lg-10">
                                                        <a href="{{ route('guest.jobDetail', ['job_id' => $relatedJob->job_id]) }}"
                ...
                <div class="course-detail-bx">
                    <div class="box box-body">
                        ...
                        <div class="text-center">
                            <a href="{{ route('login') }}" style="color: #1e1e1e">
                                <button id="favorite-btn" type="button" class="btn w-100 mb-10"
                                    style="border: 1px solid #eee">
                                    <i id="favorite-icon" class="fa-heart fa-regular"></i>
                                    Favorite
                                </button>
                            </a>
